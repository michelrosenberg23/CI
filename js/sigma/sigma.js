  ...
  function k(b) {
    ...
    function g(b, c, d) {
      if (
        ...
        (B = f.p.directZooming ? 1 - (p ? f.p.zoomDelta : f.p.dragDelta) : 0),
    ...
    function a() {
      ...
      p
        ...
        : ((f.stageX = m * (1 - a) + y * a), (f.stageY = j * (1 - a) + q * a));
  ...
  function t(b, v) {
    ...
    this.mousecaptor
      ...
      .bind("mousedown mouseup", function (b) {
        ...
        c.length &&
          a.dispatch("mousedown" == b.type ? "downnodes" : "upnodes", c);
      })
      .bind("move", function () {
    ...
    this.draw = function (b, c, d, f, i) {
      ...
      if (f)
        if (1 < f) for (; a.plotter.task_drawBG(); );
          ...
          (sigma.chronos.addTask(a.plotter.task_drawBG, "bg_" + a.id, !1),
            (i = !0),
            (g = "bg_" + a.id));
      if (b)
        if (1 < b) for (; a.plotter.task_drawNode(); );
        else
          (sigma.chronos.addTask(a.plotter.task_drawNode, "node_" + a.id, !1),
            (i = !0),
            (g = "node_" + a.id));
      if (d)
      ...
      if (d != a.width || f != a.height) {
        for (var h in a.domElements)
          (a.domElements[h].setAttribute("width", a.width + "px"),
            a.domElements[h].setAttribute("height", a.height + "px"));
    ...
    this.removeTask = function (a, b) {
      if (void 0 == a)
        ...
        r = r.filter(function (b) {
          return ("string" == typeof a ? b.taskName == a : b.task == a)
            ? ((c = b.taskName), !1)
            : !0;
        });
        0 < b &&
